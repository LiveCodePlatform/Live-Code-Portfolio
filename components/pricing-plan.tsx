      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 bg-[#5d4037] rounded-2xl rounded-b-none py-20">
        <div className="max-w-5xl mx-auto md:text-center mb-12">
          ...
          <p className="text-[22px] text-white font-medium poppins">
            Release on-brand pages fast while <br /> using your tech stack.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-lg py-8 px-10 md:h-[390px]">
            ...
            <Button
              variant="outline"
              className="w-full py-6 border-primary text-primary poppins font-medium text-[14px] hover:bg-primary hover:text-white"
            >
              Contact to Consult
            </Button>
          </div>
          ...
          <div className="bg-white rounded-lg py-8 px-10">
            ...
            <Button
              variant="default"
              className="w-full py-6 bg-[#5d4037] border-primary text-white poppins font-medium text-[14px] hover:bg-[#4e342e] hover:text-white"
            >
              Contact to Consult
            </Button>
          </div>
